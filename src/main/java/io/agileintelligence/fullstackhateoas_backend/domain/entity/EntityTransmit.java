...
public class EntityTransmit {
    ...
    public EntityTransmit(Long id, String timeFirst, String lats, String longs, String timeSecond, Boolean stateCoordinate, EntityMission mission, EntityEvent event) {
        Id = id;
