...
export class MapDirection3PageSaveLatlng extends Component {
    constructor(props) {
        super(props);
        this.state={
            cancleP:false,
    ...
    render() {
        return (
            <div className="container">
                ...
                <div
                    className='bg-secondary  position-absolute MapPageSaveOnclick  rounded row border border-secondary p-5 '>
                    <div className='row  mb-3 w-100'>
                        <label className="text-white"> نام {this.props.valueBiginOrDestination==='start'?'مبدا'  :'مقصد'} انتخابی
